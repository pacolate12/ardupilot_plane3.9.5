...
#define HAL_SPI_DEVICE1  SPIDesc("dataflash"      ,  1,  1, PAL_LINE(GPIOB,3U) , SPIDEV_MODE3,  32*MHZ,  32*MHZ)
#define HAL_SPI_DEVICE_LIST HAL_SPI_DEVICE0,HAL_SPI_DEVICE1

// ADC config
#define ANALOG_VCC_5V_PIN 13
#define HAL_HAVE_BOARD_VOLTAGE 1
#define HAL_ANALOG_PINS { \
{ 11,    3.30/4096 }, /* PC1 BATT_CURRENT_SENS */ \
{ 12,    3.30/4096 }, /* PC2 BATT_VOLTAGE_SENS */ \
{ 13,    3.30/4096 }, /* PC3 VDD_5V_SENS */ \
{ 15,    3.30/4096 }, /* PC5 USB_SENSE */ \
}

// GPIO config
#define HAL_GPIO_LINE_GPIO0 PAL_LINE(GPIOB,  5U)
#define HAL_GPIO_LINE_GPIO1 PAL_LINE(GPIOB,  6U)
#define HAL_GPIO_LINE_GPIO2 PAL_LINE(GPIOB,  4U)
...
#define HAL_GPIO_LINE_GPIO55 PAL_LINE(GPIOA,  0U)
#define HAL_GPIO_PINS { \
{   0, true,  0, PAL_LINE(GPIOB,  5U)}, /* PB5 LED_BLUE OUTPUT */ \
{   1, true,  0, PAL_LINE(GPIOB,  6U)}, /* PB6 LED_YELLOW OUTPUT */ \
{   2, true,  0, PAL_LINE(GPIOB,  4U)}, /* PB4 LED_RED OUTPUT */ \
...
{  55, true,  6, PAL_LINE(GPIOA,  0U)}, /* PA0 TIM2_CH1 TIM2 AF1 PWM6 */ \
}

// full pin define list
#define HAL_GPIO_PIN_BATT_CURRENT_SENS    PAL_LINE(GPIOC,1U)
#define HAL_GPIO_PIN_BATT_VOLTAGE_SENS    PAL_LINE(GPIOC,2U)
#define HAL_GPIO_PIN_DRDY_HMC5883         PAL_LINE(GPIOB,7U)
#define HAL_GPIO_PIN_EXTI_MPU6000         PAL_LINE(GPIOC,4U)
...
#define HAL_GPIO_PIN_LED_RED              PAL_LINE(GPIOB,4U)
#define HAL_GPIO_PIN_LED_YELLOW           PAL_LINE(GPIOB,6U)
...
#define HAL_GPIO_PIN_SBUS_INVERT          PAL_LINE(GPIOC,0U)
...
#define HAL_GPIO_PIN_TIM8_CH1             PAL_LINE(GPIOC,6U)
...
#define HAL_GPIO_PIN_USB_SENSE            PAL_LINE(GPIOC,5U)
#define HAL_GPIO_PIN_VDD_5V_SENS          PAL_LINE(GPIOC,3U)
...
#define STM32_TIM_TIM2_UP_DMA_STREAM   STM32_DMA_STREAM_ID(1, 7)
...
#define STM32_TIM_TIM8_CH1_DMA_STREAM  STM32_DMA_STREAM_ID(2, 2)
#define STM32_TIM_TIM8_CH1_DMA_CHAN    0
...
#define STM32_RCIN_DMA_STREAM STM32_TIM_TIM8_CH1_DMA_STREAM
#define STM32_RCIN_DMA_CHANNEL STM32_TIM_TIM8_CH1_DMA_CHAN
...
#define HAL_UART_DEVICE_LIST HAL_OTG1_CONFIG,HAL_USART3_CONFIG,HAL_USART1_CONFIG
...
/* PORTB:
 ...
 PB4 LED_RED OUTPUT
 PB5 LED_BLUE OUTPUT
 PB6 LED_YELLOW OUTPUT
 PB7 DRDY_HMC5883 INPUT
...
/* PORTC:
 PC0 SBUS_INVERT OUTPUT
 PC1 BATT_CURRENT_SENS ADC1 ADC1_IN11
 PC2 BATT_VOLTAGE_SENS ADC1 ADC1_IN12
 PC3 VDD_5V_SENS ADC1 ADC1_IN13
 PC4 EXTI_MPU6000 INPUT
 PC5 USB_SENSE ADC1 ADC1_IN15
 PC6 TIM8_CH1 TIM8 AF3
